...
// ==========================//
	...
	array(	"name" => __('Theme Colour', 'framework'),
	...
	"std" => "http://www.premiumpixels.com",
	"type" => "text"),
	
	array(	"name" => __("Adsense Code", 'framework'),
	"desc" => __("Include your adsence code here or leave empty if you wish to use an image.", 'framework'),
	...
	"std" => "http://feeds.feedburner.com/premiumpixels",
	"type" => "text"),
	...
	"std" => "http://feedburner.google.com/fb/a/mailverify?uri=premiumpixels",
	"type" => "text"),
	...
	array(	"name" => __("Slider", 'framework'),
	"id" => $shortname."_slider_settings",
	"type" => "title"),
	
	array(	"name" => __("Enable Slider", 'framework'),
	...
	array(	"name" => __("Post Grid", 'framework'),
	"id" => $shortname."_post_grid",
	"type" => "title"),
	
	array(	"name" => __("Enable Post Grid", 'framework'),
	...
	array(	"name" => __("Post Grid Title", 'framework'),
	...
	array(	"name" => __("Number of Post Grid Posts", 'framework'),
	...
	array(	"name" => __("Enable Featured Image", 'framework'),
	...
	array(	"name" => __("Related Post Type", 'framework'),
